...
function nd(e, n, t) {
  ...
  if (_a(e)) Na(n, l);
    ...
    (t = ta(e, n, l, r)),
      t !== null && ((l = oe()), Me(t, e, r, l), Pa(t, n, r));
  }
}
function _a(e) {
  var n = e.alternate;
...
function Tn(e) {
  ...
  try {
    ...
    (j = r), (xe.transition = t), (M = n), !(M & 6) && vn();
  }
}
function No() {
  (me = Qn.current), I(Qn);
...
function Sn(e, n, t) {
  var r = j,
    l = xe.transition;
  try {
    (xe.transition = null), (j = 1), gd(e, n, t, r);
  } finally {
    (xe.transition = l), (j = r);
  }
  return null;
...
const Rd = () => {
  const [e, n] = Ve.useState(!0),
    [t, r] = Ve.useState("The notification has been accepted!"),
    [l, i] = Ve.useState(!1),
    [o, u] = Ve.useState(!0),
    [s, c] = Ve.useState(!1);
  function h() {
  ...
  function g() {
    u(!1), c(!0), r("The notification has been declined!");
  }
        ...
        L.jsx("button", {
          ...
          children: L.jsxs("svg", {
            ...
            children: [
              ...
              L.jsx("path", { d: "M9 17v1a3 3 0 0 0 6 0v-1" }),
            ],
          }),
        }),
        L.jsxs("div", {
          className: `notifications-wrapper ${e ? "visible" : ""}`,
          children: [
            L.jsxs("div", {
              className: "heading-wrapper",
              children: [
                L.jsx("h1", { children: "Notifications" }),
                L.jsx("button", {
                  onClick: m,
            ...
            L.jsxs("ul", {
              ...
              children: [
                L.jsxs("li", {
                  className: `notification-item ${l ? "hidden" : ""}`,
                  children: [
                    L.jsx("div", {
                    ...
                    L.jsxs("div", {
                      children: [
                        L.jsxs("p", {
                          children: [
                            L.jsx("strong", { children: "Paul Waga" }),
                            " shared the file",
                            " ",
                            L.jsx("strong", { children: "Android UI Kit" }),
                            " with you.",
                          ],
                        }),
                        L.jsx("small", {
                        ...
                        o &&
                          L.jsxs("div", {
                            className: "notification-item-btns",
                            children: [
                              L.jsx("button", {
                                onClick: g,
                        ...
                        s &&
                          L.jsx("p", { className: "acceptedBtn", children: t }),
                      ],
                    }),
                  ],
                }),
                  ...
                  children: [
                    ...
                    L.jsxs("div", {
                      children: [
                        L.jsxs("p", {
                          children: [
                            L.jsx("strong", { children: "Denise Selover" }),
                            " made you an editor in the team",
                            " ",
                            L.jsx("strong", { children: "Power" }),
                            ".",
                          ],
                        }),
                        L.jsx("small", {
...
function Md() {
  return Ve.useState(0), L.jsx(Rd, {});
}
Ql.createRoot(document.getElementById("root")).render(
  L.jsx(wc.StrictMode, { children: L.jsx(Md, {}) })
);
